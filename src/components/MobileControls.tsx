      ...
      <div className="md:hidden">
        {!showControls && (
          <button
            ...
            className="fixed right-4 bottom-4 z-50 bg-accent hover:bg-active text-primary-text p-3 rounded-full shadow-lg transition-colors"
          >
        ...
        >
          <div className="bg-background p-3 rounded-t-xl border-t border-divider shadow-lg">
            <div className="flex items-center justify-between p-4 border-b border-divider">
              <h3 className="text-lg font-medium text-primary-text">Controls</h3>
              <button
                onClick={onToggleControls}
                className="text-subtext hover:text-primary-text transition-colors p-1"
            ...
            <div className="p-4">
              <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium min-w-[40px] ${enableRepeat
                        ...
                        : 'bg-accent text-primary-text opacity-60'
                        }`}
                    >
                      {enableRepeat ? 'ON' : 'OFF'}
                    </button>
                    ...
                    {enableRepeat ? (
                      <>
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center bg-accent hover:bg-active rounded-full text-primary-text"
                        >
                          -
                        </button>
                        <span className="text-sm text-primary-text">{repeatCount}</span>
                        <button
                ...
                <div className="grid grid-cols-2 gap-3">
                  {/* Speed Controls */}
                  <div className="bg-surface p-3 rounded-lg">
                    <div className="text-sm font-medium mb-2 text-primary-text">Speed</div>
                    <div className="flex items-center justify-between">
                      <button
                        ...
                        className={`w-7 h-7 flex items-center justify-center rounded-full text-sm ${playbackSpeed <= 0.25
                          ? 'bg-accent text-primary-text opacity-30'
                          : 'bg-accent hover:bg-active text-primary-text'
                          }`}
                      >
                        -
                      </button>
                      <span className="text-sm text-primary-text">{playbackSpeed}x</span>
                      <button
                  ...
                  {/* Font Size Controls */}
                  <div className="bg-surface p-3 rounded-lg">
                    <div className="text-sm font-medium mb-2 text-primary-text">Font Size</div>
                    <div className="flex items-center justify-between">
                      <button
                      ...
                      <span className="text-sm text-primary-text">{fontSize}px</span>
                      <button
